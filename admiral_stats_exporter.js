(function () {
  ...
  var version = 'Admiral Stats エクスポータ v1.15.0';
  ...
  var dataTypes = ['Personal/basicInfo', 'TcBook/info', 'CharacterList/info', 'Event/info', 'BlueprintList/info', 'EquipBook/info', 'EquipList/info'];
